...
class SummaryFragment : Fragment() {
    ...
    var diagnosisArraySummary=ArrayList<GetDiagnosisData>()
    ...
    override fun onCreateView(
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            Log.e("diagnosisArray=",DiagnosisFragment.diagnosisArray.toString())
                     binding.idRecyData.layoutManager=LinearLayoutManager(requireContext())
                     binding.idRecyData.adapter=DiagnosAdapter(DiagnosisFragment.diagnosisArray)
...
//        )
        ...
        if(name!=null)
        {
                ...
                var changeDobFormat: String = formatter.format(parser.parse(dateOfBirth))

                binding.idtxYear.text = Utils.dobToAge(changeDobFormat)
            ...
            var diagnosisArray:ArrayList<GetDiagnosisData> = DiagnosisFragment.diagnosisArray
...
//                    binding.idRecyData.layoutManager=LinearLayoutManager(requireContext())
     ...
     )
     {
        ...
        // binding.idtxEndDateId.text=dobEnd
         ...
         Log.e("passingLog=","name="+name+"=gender="+gender+"=dateofbirth="+dob+"subscription="+subscriptionId+"s=startDob="+startDob+"montlyplan="+monthlyPlan+"=endDob="+dobEnd)

     }

    fun passArray(slist:ArrayList<GetDiagnosisData>)
    {
