...
//        val uuid:String=requireArguments().getString("uuid").toString()
        ...
        viewModel=
            ViewModelProvider(requireActivity(), ProfileDetailViewModelFactory(requireContext())).get(
