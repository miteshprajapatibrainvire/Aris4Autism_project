...
class HowItWorksMainFragment : Fragment() {
    ...
    ): View
    {
        ...
        binding.topToolbarHowitWork.txIdMainLabel.text="HOW IT WORKS"
        ...
        viewmodel.resultHowItWork.observe(requireActivity(),{
            ...
            when(it)
            {
                is BaseResponse.Success->
                {
                    ...
                    Log.e("mainLearner=",mainLearnerWork.toString())
                }
        ...
        tabAdapter.addFragment(HowLearnerWorksFragment(mainLearnerWork!!) ,"Learners")
